...
namespace PureManApplicationDeployment
{
    ...
    public class PureManClickOnce
    {
        ...
        public PureManClickOnce(string publishPath)
        {
            ...
            {
                var programData = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), @"Apps\2.0\Data\");
        ...
        public async Task<bool> Update()
        {
            ...
            if (_From == InstallFrom.Web)
            {
                ...
                setupPath = Path.Combine(GetDownloadFolderPath(), $"setup{serverVersion}.exe");
